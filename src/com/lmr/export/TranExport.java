...
public class TranExport {
    public static void export(Integer currentpage,TranVo tranVo) {
        //实例化一个dao类对象
        TranDao tranDao = new TranDaoImpl();
        List<Tran> page = tranDao.page(currentpage, Constant.PAGE_SIZE, tranVo);//获取数据
        //标题
